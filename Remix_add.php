                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <?php
                        ...
                        if(isset($_GET['submit'])){
                            ...
                            $tt_t = $_GET['tt_t'];
                            $sql = "update remix_add set ";
                            $sql .= "us_id='$us_id',us_fname='$us_fname',us_lname='$us_lname',us_ttl='$us_ttl',add_name='$add_name',mv_name'$mv_name',tt_name='$tt_name',tt_t='$tt_tt'";
